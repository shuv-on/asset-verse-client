...
const NavBar = () => {
    ...
    const getLinkClass = ({ isActive }) =>
        `flex items-center gap-2 m-2 hover:border-b-2 hover:border-green-500 font-medium ${isActive ? 'border-b-2 border-green-500 text-green-500' : ''}`;
                    ...
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow text-gray-500">
                            ...
                            {!user ? (
                                <>
                                    <li className="mt-2">
                                        <Link to="/login" className="btn btn-success btn-sm w-full text-white">Login</Link>
                                    </li>
                                </>
                            ) : (
                                <li className="mt-2">
                    ...
                    <div className='mx-2 md:mx-5'>
                        <Link to="/" className='flex items-center justify-around gap-2'>
                            ...
                            <h1 className='text-xl font-bold'>
                                <span className='text-green-500'>Asset</span>
                                <span className='text-gray-500 dark:text-white'>Verse</span>
                            </h1>
                        </Link>
                    </div>
                ...
                <div className="navbar-end gap-0.5 sm:gap-2">
                    ...
                    {user ? (
                        <div className="flex items-center gap-2">
                            <div className="tooltip tooltip-bottom" data-tip={user.displayName || 'User'}>
                                <div className="avatar">
                                    <div className="w-10 rounded-full cursor-pointer ring-2 ring-green-500 ring-offset-base-100 ring-offset-2">
                                        <img 
                                            alt="User" 
                            ...
                            <button 
                                className="btn bg-green-500 hover:bg-green-600 sm:btn-sm md:btn-md text-white border-none"
                            >
                                LogOut
                            </button>
                        </div>
                        ...
                        <div className='flex gap-2'>
                             <Link to="/login" className="btn btn-success btn-xs sm:btn-sm md:btn-md text-white">Login</Link>
                        </div>
                    )}
                </div>
            </div>
